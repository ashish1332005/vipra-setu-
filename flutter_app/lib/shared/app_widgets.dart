...
IconData _serviceIcon(String value) {
  ...
  if (text.contains('home services') || text == 'home') {
  ...
  if (text.contains('hospital') || text.contains('care')) {
...
String serviceAssetFor(String value) {
  final text = value.toLowerCase();
  if (text.contains('home services') || text == 'home') {
    return AppAssets.categoryHomeServices;
  }
  ...
  if (text.contains('beauty') || text.contains('wellness')) {
    return AppAssets.categoryBeautyWellness;
  }
